...
| 종합 내용 | 8주간 2주 단위 미니 프로젝트 4개를 수행하며, 실제 서비스를 반복 개발을 통해 학습을 진행한다.<br>개발자 환경이 잘 갖춰진 배민에서 실제 업무와 관련된 학습과 실무를 경험할 수 있다.<br><br>학력이나 경력에 대한 제한은 전혀 없고, 활동 기간이 비교적 짧은 편이기에 개발자 중<br>개발을 다시 학습하거나 신입 개발자 공채를 노리는 분이라면 추천해볼만 하다.<br><br>사실 가장 지원해보고 싶은 캠프였는데, 알고리즘 역량이 부족해서 코딩테스트 광탈이 예상되었기에 포기했다... |
