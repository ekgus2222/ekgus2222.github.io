...
| 종합 내용 | 멤버십 기간동안, 특정 언어에 대한 학습보단, 주 단위 미션을 통해 자기주도적으로 문제 해결을 고민하며 해결하는 학습 스프린트 8주 과정 + 도전적인 난이도로 실전 프로젝트를 수행하는 7주 과정을 수행한다.<br>같은 열정을 지닌 개발자가 모여 함께 문제를 해결해나가는 만큼, 많은 것을 배울 수 있는 캠프.<br>함께 지속 가능한 개발을 추구하는 동료 네트워크를 얻을 수 있다.<br>개발 역량을 지닌 개발자들에게 추천하는 캠프이며, 비전공자 및 개린이는 벅찰 수 있다..
<br>프로젝트를 통해 포트폴리오를 쌓거나 네이버/카카오 입사를 희망한다면 도전해보자. |
